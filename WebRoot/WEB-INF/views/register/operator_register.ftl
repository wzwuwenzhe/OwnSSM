...
<@htmlBody>
	<@form action="/operatorRegister" onsubmit="return $form.submit(this,_loginCallback);" class="fh5co-form animate-box" h2="操作员注册">
		<@form_group id="storeId" value="店铺ID" name="storeId" type="text" dataType="NumberMax8" msg="店铺ID长度为8位数字"/>
		<@form_group id="opName" value="您的姓名" name="name" type="text" dataType="Chinese" msg="必须为中文,请填您的真实姓名"/>
		<@form_group id="mobilephone" value="手机" name="phone" type="text" dataType="Phone" msg="手机号码错误"/>
		...
		<@form_group id="loginName" value="登录名" name="loginName" type="text" dataType="Code" msg="登录名必须为英文或数字"/>
		<@form_group id="password" value="密码" name="pwd" type="password" dataType="PWD" msg="密码是必须大于8位小于20位的英文或数字"/>
		<!--
