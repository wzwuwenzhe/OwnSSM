...
public class Deady {
	...
	static final int EPSON_VENDOR_ID = 1208;
	...
	// return EpsonTools.getErrorText(errorcode);
	// }
	...
	public static enum ASCII_CONTROL_CODE {
		NUL(0), SOH(1), STX(2), ETX(3), EOT(4), ENQ(5), ACK(6), BEL(7), BS(8), HT(
				...
				24), EM(25), SUB(26), ESC(27), FS(28), GS(29), RS(30), US(31), AT(
				64);
	...
	public static enum DATA_TYPE {
		GENERAL, MICR, IMAGE, DEVICESTATUS, ASB, INKSTATUS, EJ_DATA, NOTHING;
	}
	...
	public static enum IMAGEFORMAT {
		RAW, BMP, TIFF, TIFF_COMP, JPEG_HIGH, JPEG_MED, JPEG_LOW;
	}
	...
	static enum RECEIVESTATE {
		RSTATE_SINGLE, RSTATE_INKSTATUS, RSTATE_EXTSTATUS, RSTATE_ASB, RSTATE_BLOCK_HEXADECIMAL, RSTATE_BLOCK_BINARY, RSTATE_MICR, RSTATE_WAVEFORM, RSTATE_EJDATA;
	}
